<script lang="ts">
    ...
    const modifica = async (codice_articolo: string) => {
        ...
        if (result.success) {
            ...
            alert("Codice articolo esistente");
        }
            ...
            <table>
                ...
                <tbody>
                    {#each risultati as item}
                        <tr>
                            {#if swm === 1 && codice1 === item.codice_articolo}
                            ...
                            {:else}
                                ...
                                <td>
                                    <!-- svelte-ignore a11y_consider_explicit_label -->
                                    <button class="svg" onclick={() => modificaLayout(item)}><svg width="30px" height="30px" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#217eca">

                                        <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                                        
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
                                        
                                        <g id="SVGRepo_iconCarrier"> <rect width="48" height="48" fill="white" fill-opacity="0.01"/> <path d="M42 26V40C42 41.1046 41.1046 42 40 42H8C6.89543 42 6 41.1046 6 40V8C6 6.89543 6.89543 6 8 6L22 6" stroke="" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/> <path d="M14 26.7199V34H21.3172L42 13.3081L34.6951 6L14 26.7199Z" fill="217eca" stroke="" stroke-width="4" stroke-linejoin="round"/> </g>
